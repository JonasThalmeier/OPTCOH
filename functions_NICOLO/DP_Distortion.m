...
delay_phase_distorted_RX_Xpol = conv(PulseShaping_b_coeff, delay_phase_distorted_RX_Xpol);
delay_phase_distorted_RX_Ypol = conv(PulseShaping_b_coeff, delay_phase_distorted_RX_Ypol);
